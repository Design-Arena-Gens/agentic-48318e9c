      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl gradient-text mb-4"
          >
          ...
          >
            3 years of experience building modern, responsive, and scalable web applications.
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 bg-primary text-slate-950 rounded-lg font-semibold hover:bg-primary/90 transition"
            >
              Get In Touch
            </motion.a>
            <motion.a
